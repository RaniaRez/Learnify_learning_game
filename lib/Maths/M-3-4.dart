...
class M_3_4 extends StatefulWidget {
  const M_3_4({Key key}) : super(key: key);

  @override
  _M_3_4State createState() => _M_3_4State();
}
...
class _M_3_4State extends State<M_3_4> {
  ...
  Future loadMusic() async {
    ...
    advancedPlayer = await AudioCache().play("audio/maths00.wav");
  }
          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/M-3-Q-4.svg'),
              ),
              Visibility(
                visible: Visible,
                child: Positioned(

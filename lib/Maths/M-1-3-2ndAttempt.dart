...
class M_1_3_2nd extends StatefulWidget {
  const M_1_3_2nd({Key key}) : super(key: key);

  @override
  _M_1_3_2ndState createState() => _M_1_3_2ndState();
}
          ...
          child: Stack(
            children: <Widget>[
                  ...
                  int result = await advancedPlayer?.pause();}
                    ...
                    setState(()  {
                      ...
                      if(!all){
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => I_M_1_3_()));
                        print('Wrong');
                      }
                    });
                    print("HELL YEAH");
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/M-1-Q-3-2.svg'),
              ),

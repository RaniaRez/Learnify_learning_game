...
class M_1_2_3rd extends StatefulWidget {
  const M_1_2_3rd({Key key}) : super(key: key);

  @override
  _M_1_2_3rdState createState() => _M_1_2_3rdState();
}

class _M_1_2_3rdState extends State<M_1_2_3rd> {
  bool oneD = false;
  bool oneU = false;
  bool twoD = false;
  bool twoU = false;
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/bulleAppliquer2.svg'),
              ),

...
class M_2_2_3rd_ extends StatefulWidget {
  const M_2_2_3rd_({Key key}) : super(key: key);

  @override
  _M_2_2_3rd_State createState() => _M_2_2_3rd_State();
}
class _M_2_2_3rd_State extends State<M_2_2_3rd_> {
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/M-2-Q-2-3.svg'),
              ),
              Visibility(
                visible:!Visible,
                child: Positioned(

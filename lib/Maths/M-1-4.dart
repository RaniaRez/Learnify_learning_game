...
class M_1_4 extends StatefulWidget {
  const M_1_4({Key key}) : super(key: key);

  @override
  _M_1_4State createState() => _M_1_4State();
}

class _M_1_4State extends State<M_1_4> {
          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/M-1-Q-4.svg'),
              ),
              Visibility(
                visible: Visible,
                child: Positioned(

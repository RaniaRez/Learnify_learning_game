...
class M_2_3 extends StatefulWidget {
  const M_2_3({Key key}) : super(key: key);

  @override
  _M_2_3State createState() => _M_2_3State();
}
class _M_2_3State extends State<M_2_3> {
...
if ( player2 != null) {
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/M-2-Q-3.svg'),
              ),
              Visibility(
                visible:!Visible,
                child: Positioned(

...
class M_1_5_3rd_1 extends StatefulWidget {
  const M_1_5_3rd_1({Key key}) : super(key: key);

  @override
  _M_1_5_3rd_1State createState() => _M_1_5_3rd_1State();
}

class _M_1_5_3rd_1State extends State<M_1_5_3rd_1> {
          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/bulleAppliquer5-2.svg'),
              ),
              Visibility(
                visible: Visible,
                child: Positioned(

...
class M_2_5_2nd_Three extends StatefulWidget {
  const M_2_5_2nd_Three({Key key}) : super(key: key);

  @override
  _M_2_5_2nd_ThreeState createState() => _M_2_5_2nd_ThreeState();
}
class _M_2_5_2nd_ThreeState extends State<M_2_5_2nd_Three> {
              ...
              Visibility(
                ...
                child: Positioned(
                    ...
                    child: ButtonContinuer(onPressed: (){
                      ...
                      if ((scoreM.niv2>7.5)||(scoreM.niv3>=0)){
                        Navigator.push(
                            context,

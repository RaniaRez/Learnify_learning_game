...
class Geo2 extends StatefulWidget {
  @override
  _Geo2State createState() => _Geo2State();
}

class _Geo2State extends State<Geo2> {
  ...
  Future loadMusic() async {
    ...
    advancedPlayer = await AudioCache().play("audio/Geo2.wav");
  }
        ...
        child: Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                top:size.height*0.2,
                child:SvgPicture.asset("assets/icons/bulleN2.svg"),
              ),
              Positioned(
                top: size.height*0.8,
                left:size.width*0.75,

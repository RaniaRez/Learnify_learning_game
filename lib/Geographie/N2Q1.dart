...
import 'package:somthn/Geographie/N2Q1T2_C_1.dart';
import 'package:somthn/Geographie/N2Q1T2_C_2.dart';
import 'package:somthn/Geographie/N2Q1T2_C_3.dart';
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (threeClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N2Q1T2_C_3()));
                              print('Wrong');
                            });
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (twoClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N2Q1T2_C_2()));
                              print('Wrong');
                            });

...
class N3Q2T2_C_3 extends StatefulWidget {
  const N3Q2T2_C_3({Key key}) : super(key: key);

  @override
  _N3Q2T2_C_3State createState() => _N3Q2T2_C_3State();
}

class _N3Q2T2_C_3State extends State<N3Q2T2_C_3> {
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/BulleN3Q2T2.svg'),
              ),
              Visibility(
                visible: !Visible,
                child: Positioned(

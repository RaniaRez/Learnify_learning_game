...
class N3Q5T2_C_3 extends StatefulWidget {
  const N3Q5T2_C_3({Key key}) : super(key: key);

  @override
  _N3Q5T2_C_3State createState() => _N3Q5T2_C_3State();
}

class _N3Q5T2_C_3State extends State<N3Q5T2_C_3> {
  bool Visible = true;
  bool correct = false;

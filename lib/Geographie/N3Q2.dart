...
import 'package:somthn/Geographie/N3Q2T2_C_1.dart';
import 'package:somthn/Geographie/N3Q2T2_C_2.dart';
import 'package:somthn/Geographie/N3Q2T2_C_3.dart';
...
class N3Q2 extends StatefulWidget {
  const N3Q2({Key key}) : super(key: key);
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/BulleN3Q2.svg'),
              ),
              Visibility(
                visible: !Visible,
                child: Positioned(
              ...
              Visibility(
                ...
                child: Positioned(
                  ...
                  child: IconButton(
                    icon: SvgPicture.asset('assets/icons/Monument.svg'),
                    onPressed: () async {
                      player2?.stop();
                      if (advancedPlayer!=null){
                  int result = await advancedPlayer?.pause();}
              ...
              Visibility(
                ...
                child: Positioned(
                  ...
                  int result = await advancedPlayer?.pause();}
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => N3Q3()));
                      print('Continuer');},)
                ),
              ),
              if (user.avatar=="Pink")
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (threeClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N3Q2T2_C_3()));
                              print('Wrong');
                            });
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (twoClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N3Q2T2_C_2()));
                              print('Wrong');
                            });

...
class Geo3 extends StatefulWidget {
  @override
  _Geo3State createState() => _Geo3State();
}

class _Geo3State extends State<Geo3> {
  ...
  Future loadMusic() async {
    ...
    advancedPlayer = await AudioCache().play("audio/Fr3.wav");
  }

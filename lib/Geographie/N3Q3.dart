...
import 'package:somthn/Geographie/N3Q3T2_C_2.dart';
...
class N3Q3 extends StatefulWidget {
  const N3Q3({Key key}) : super(key: key);

  @override
  _N3Q3State createState() => _N3Q3State();
}
class _N3Q3State extends State<N3Q3> {
                        ...
                        onPressed: (){
                          if (threeClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N3Q3T2_C_3()));
                              print('Wrong');
                            });
                        ...
                        onPressed: (){
                          if (twoClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N3Q3T2_C_2()));
                              print('Wrong');
                            });
                    ...
                    child: IconButton(
                        onPressed: (){
                          if (oneClicked)  {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => N3Q3T2_C_1()));
                            print('Wrong');
                          }
                          print('3');
                        },

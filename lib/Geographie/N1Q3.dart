...
class N1Q3 extends StatefulWidget {
  ...
  @override
  _N1Q3State createState() => _N1Q3State();
}
class _N1Q3State extends State<N1Q3> {
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/BulleN1Q3.svg'),
              ),
              Visibility(
                visible: !Visible,
                child: Positioned(
                          ...
                          if (threeClicked){
                           // Vibration.vibrate();
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N1Q3T2_C_3()));
                              print('Wrong');
                            });
                          ...
                          if (fourClicked){
                           // Vibration.vibrate();
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N1Q3T2_C_4()));
                              print('Wrong');
                            });
                ...
                child: Visibility(
                  ...
                  int result = await advancedPlayer?.pause();}
                          ...
                          //  Vibration.vibrate();
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => N1Q3T2_C_1()));
                            print('Wrong');
                          }
                          print('3');
                        },

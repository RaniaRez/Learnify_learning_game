...
import 'package:somthn/Geographie/N2Q4T2_C_1.dart';
import 'package:somthn/Geographie/N2Q4T2_C_3.dart';
import 'package:somthn/Geographie/N2Q4T2_C_4.dart';
...
class N2Q4 extends StatefulWidget {
  const N2Q4({Key key}) : super(key: key);

  @override
  _N2Q4State createState() => _N2Q4State();
}
class _N2Q4State extends State<N2Q4> {
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child:SvgPicture.asset('assets/icons/BulleN2Q4.svg'),
              ),
              Visibility(
                visible: !Visible,
                child: Positioned(
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (threeClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N2Q4T2_C_3()));
                              print('Wrong');
                            });
                  ...
                  int result = await advancedPlayer?.pause();}
                          if (fourClicked){
                            ...
                            setState(() {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => N2Q4T2_C_4()));
                              print('Wrong');
                            });
                    ...
                    child: IconButton(
                        onPressed: (){
                          if (oneClicked)  {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => N2Q4T2_C_1()));
                            print('Wrong');
                          }
                          print('3');
                        },

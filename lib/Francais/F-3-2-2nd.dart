...
class F_3_2_2nd extends StatefulWidget {
  const F_3_2_2nd({Key key}) : super(key: key);

  @override
  _F_3_2_2ndState createState() => _F_3_2_2ndState();
}

class _F_3_2_2ndState extends State<F_3_2_2nd> {
  bool Visible = true;
  bool correct = false;
  @override
